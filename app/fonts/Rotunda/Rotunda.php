...
add_action( 'admin_init', array('MyFontsInstaller_333811','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_333811','myfonts_loadupWebfonts' ));
